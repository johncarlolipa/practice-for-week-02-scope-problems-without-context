...
const smoothieMachine = (...initialIngredients) => {
  return function(...additionalIngredients){
    const allIngredients = [...initialIngredients, ...additionalIngredients]
    const ingredientList = allIngredients.join(' and ')
    return `I'm having a smoothie with ${ingredientList}`;
  }
};
